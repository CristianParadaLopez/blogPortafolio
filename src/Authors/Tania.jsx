...
// Iconos
import { FaGithub, FaMapMarkerAlt, FaGraduationCap, FaMicrochip, FaTools } from "react-icons/fa";

const Tania = () => {
  const tania = authors.find(author => author.slug === 'tania');

  useEffect(() => {
    if (tania) document.title = `Portafolio | ${tania.name}`;
  }, [tania]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    emailjs.send("service_lv0sqre", "template_75cpuzc", { ...formData, to_email: tania.contact.email, to_name: tania.name }, "tsS_zRPGc6SdgkNoL")
      .then(() => {
        setSuccess(true);
        setLoading(false);
  ...
  const techStack = [
    ...
    { nombre: "Hardware", icon: "bx-hdd", color: "hover:text-[#FFD02F]" },
    ...
    { nombre: "Flutter", icon: "bxl-flutter", color: "hover:text-[#02569B]" },
    { nombre: "Dart", icon: "bx-code-curly", color: "hover:text-[#0175C2]" },
    { nombre: "Mecatrónica", icon: "bx-cog", color: "hover:text-[#DE3642]" },
  ];
    ...
    <div className="bg-black text-gray-200 min-h-screen selection:bg-[#DE3642] selection:text-white">
      ...
      <section className="relative pt-20 pb-16 lg:pt-32 lg:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-r from-[#DE3642] to-blue-600 rounded-full blur opacity-25 group-hover:opacity-50 transition duration-1000 animate-pulse"></div>
              <img
                src={tania.image}
                alt={tania.name}
                className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full object-cover border-4 border-black shadow-2xl"
              />
              <a href={tania.contact.github} target="_blank" rel="noreferrer">
                <div className="absolute bottom-5 right-5 bg-[#DE3642] p-4 rounded-full shadow-lg hover:scale-110 transition-transform">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                Soy <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-300 to-gray-600">{tania.name}</span>
              </motion.h1>
      ...
      <section className="py-2 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4 italic uppercase tracking-tighter">Technical Stack</h2>
            ...
            <div className="flex w-max flex-nowrap">
              <div className="flex items-center animate-infinite-scroll py-4 whitespace-nowrap">
                {[...techStack, ...techStack].map((tech, index) => (
                  <div key={index} className="flex items-center gap-4 mx-12 group">
            ...
            {[
              ...
              <motion.div whileHover={{ y: -5 }} key={idx} className="p-8 rounded-3xl bg-[#0a0a0a] border border-white/5 hover:border-[#DE3642]/30 transition-all">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.skills.map((s, i) => (
                    <span key={i} className="px-3 py-1 rounded-lg bg-white/5 text-gray-400 text-[10px] uppercase font-bold tracking-wider group-hover:text-white">
                      {s}
                    </span>
                  ))}
                </div>
      ...
      <section id="proyectos" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4 italic uppercase tracking-tighter">Engineering Portfolio</h2>
            <div className="w-20 h-1 bg-[#DE3642] mx-auto"></div>
          </div>
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-b from-[#111] to-black rounded-[3rem] p-8 md:p-16 border border-white/5 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">¿Tienes un proyecto de hardware o software en mente? Cuéntame más.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {loading ? "Enviando..." : <>Enviar Propuesta <i className='bx bx-paper-plane'></i></>}
              </button>
