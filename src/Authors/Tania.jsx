...
const Tania = () => {
  useEffect(() => {
    document.title = "Portafolio | Tania Góchez";
  }, []);
 ...
 const proyectosWeb = [
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          ...formData,
          to_email: "garaygocheztanialisbeth@gmail.com",
          to_name: "Tania"
        },
        "tsS_zRPGc6SdgkNoL"
      )
  ...
  <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2">
    ...
    <h1 className="text-4xl sm:text-5xl font-bold font-[Rubik_Dirt] mb-4">
      Hola, soy Tania Góchez
    </h1>

    <h3 className="text-xl text-[#DE3642] font-semibold">
      Desarrolladora y Especialista en Hardware
    </h3>
    <a 
      ...
      >
        ...
        <div className="mt-12 lg:mt-0 lg:w-1/2 max-w-xl">
          ...
          <p className="text-lg leading-relaxed mb-8">
            ...
            apasionada por transformar ideas en código funcional,
